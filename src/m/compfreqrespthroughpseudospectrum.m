    % Frequency Response through Pseudospectrum:
    ...
    axis equal
    axis tight
    if saveplo, saveas(100, [matrixpth,figdir,'freqrespthroughpseudospectrumgrid.fig']), close, end
    ...
    save( fullfile(matrixpth,figdir,'freqrespthroughpseudospectrum.mat'), 'omega','sigma' )
...
%    if saveplo, saveas(gcf,[matrixpth,figdir,'pseudospectrum.fig']), close, end
    ...
    %set(gca,'DataAspectRatio',[1 pi 1])
    %axis tight
    %if saveplo, saveas(gcf,[matrixpth,figdir,'freqrespthroughpseudospectrum.fig']), close, end
